...
Канал #6 USB2.0, выведенный на mini PCI-E разьём либо выключается при инициализации WLAN, либо не надействован вообще. При этом физически контакты на плате разведены, если верить схемотехнике платы ```Compal LA-4891P```.
