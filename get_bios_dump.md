...
ЛЮБОЕ ковыряние в BIOS необходимо насинать с создания бекапа содержимого конкретного компьютера.
...
Если нет SPI-программатора, как не было у меня, то вариант либо сходить в сервис слить дамп, либо собрать по-быстрому свой, поддерживающий запись для конкретной микросхемы.  

## Used SW
- Проект SPI программатора на STM32 [vseprog](https://github.com/dword1511/stm32-vserprog) - 
...
В корне репозитория [datasheet]() на эту микросхему.
